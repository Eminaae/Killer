...
/**
 * Inserts person information into the database.txt file
 * @author USER
 *
 */
public class InsertInfo extends JFrame {
	...
	public class event implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				String word = text1.getText() + ", " + text2.getText() + ", " +  text3.getText() + "." + text4.getText() + "."
						+ text5.getText() + ". " ;
...
//		window.setSize(300, 265);
//		window.setTitle("Writer");
