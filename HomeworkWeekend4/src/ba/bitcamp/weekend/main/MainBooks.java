package ba.bitcamp.weekend.main;

import ba.bitcamp.weekend4.homework.AuthorBooks;
import ba.bitcamp.weekend4.homework.Book;
...
public class MainBooks {
	...
	public static void main(String[] args) {
			...
			Book b8 = new Book("Ne tuguj, bronzana stražo", 1970, "Short story", true);
		 ...
		 */
		public static int getNumberOfWrittenBooks(AuthorBooks a, int year1, int year2){
			int counter = 0;
			for (int i = 0; i < a.books.length; i++) {
				if(a.books[i].yearPublished >= year1 && a.books[i].yearPublished <= year2){
					counter++;
				}
			}
			return counter;		
		 ...
		 * @throws NullPointerException When null is passed as parameter
		 */
		public static AuthorBooks getAuthorWithMostBestsellers(AuthorBooks[] authors) throws NullPointerException{
			if(authors == null){
