...
public class Result {
	...
	public static void serverError(BufferedWriter bw) throws IOException{
		response(bw, " 500 Internal Server error", "bugs in the code");
	}
	
	private static void response(BufferedWriter bw, String responseCode, String responseContent) throws IOException{
