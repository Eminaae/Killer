...
public class ColorPicker extends JPanel {
	private static final long serialVersionUID = -7109799192482613152L;
	...
	private void initButton(int width, int height) {
		...
		click.setOpaque(true); // da porimi boju pozadine
		click.setBorderPainted(false); // nema granica oko dugmica
		...
		click.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Clipboard clip = Toolkit.getDefaultToolkit()
						.getSystemClipboard(); // daje pristup clipboadru
