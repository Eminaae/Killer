...
public class MineSweeper extends JFrame {
	...
	private ImageIcon img = new ImageIcon("src/vjezbeS07D04/bomb3.png");
	private static ImageIcon img1 = new ImageIcon("src/vjezbeS07D04/booom.png");
...
//	public static JMenuItem item3 = new JMenuItem("Easy");
//	public static JMenuItem item4 = new JMenuItem("Medium");
//	public static JMenuItem item5 = new JMenuItem("Hard");
	public static JPanel panel = new JPanel();
	public static JPanel panel1 = new JPanel();
	public JLabel b1 = new JLabel("Number of opend fields:");
	public JLabel b2 = new JLabel("Number of bombs: ");
...
//		menu2.add(item5);
		...
		panel1.add(b1);
		panel1.add(b2);
		b2.setText("Number of bombs: " + Mine.numberOfBombs);
		...
		for (int i = 0; i < mine.length; i++)
			for (int j = 0; j < mine[i].length; j++) {
				if (buttons[i][j].isEnabled() != false) {
					counter++;
					b1.setText("Number of closed field: " + counter);
				}
			}
